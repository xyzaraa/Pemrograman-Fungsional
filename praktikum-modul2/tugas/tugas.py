...
def create_board(width, back_board='-'):
    board = [[back_board for _ in range(width)] for _ in range(width)]
    return board

#menentukan posisi awal A dan O 
...
#memastikan supaya bidak berada di papan sesuai inputan user
...
def main():
    ...
    position_generator = generate_board(width)
